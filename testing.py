...
booting = ['Scarlet Assistant version 1.0 has begun', 'Scarlet Assistant at your service',
           'Currently starting Scarlet Virtual Assistant', "Loading drivers and modules",
           "Scarlet assistant is booting up"]
greetings = ["hello", "hello there", "Hi,I am Scarlet", "What is up user", "Scarlet at your service",
...
userGreet = ["how can I be of assistance today", "your wish is my command",
             "I am Scarlet,your personal virtual assistant", "how are you today"]
...
musical = ["What are we watching today", "Are gonna to sing some karaoke", "Listening to some music today",
           "Good thing I have my dancing module in", "My favorite youtuber is Shane Dawson",
           "Let's start our own channel"]
